...
PM_START_TEXT = """
**Hello {}, My Name is {}!** 
I am an **SUPERB**  group management bot developed by @Cosmosify.
...
TECHNO_IMG = "https://telegra.ph/file/64c964541a3fafa3a9f19.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/avhelpdesk")],
                                                                                   [InlineKeyboardButton(text="ADD ArpitVaishy TO YOUR GROUP",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Source Code",
                                                                       url="https://github.com/arpitvaishy/GRANDROBOT")
                                                                                 ]]))

    else:
        update.effective_message.reply_text("Yo! This dude Is online😎")
